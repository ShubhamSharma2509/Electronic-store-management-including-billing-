...
class categoryClass:
    ...
    #=============title===============
        ...
        lbl_name=Label(self.root,text="Enter Category Name:", font=("goudy old style",30),bg="white").place(x=45,y=70)

        txt_name=Entry(self.root,textvariable=self.var_name, font=("goudy old style",18),bg="lightyellow").place(x=50,y=130,width=640,height=31)

        btn_add=Button(self.root,text="ADD", command=self.add ,font=("goudy old style",15),bg="#4caf50" ,fg="white",cursor="hand2").place(x=50,y=180,width=310,height=35)

        btn_delete=Button(self.root,text="Delete", command=self.delete, font=("goudy old style",15),bg="red" ,fg="white",cursor="hand2").place(x=380,y=180,width=310,height=35)


        #=========category details================

        cat_frame=Frame(self.root,bd=3,relief=RIDGE)
        cat_frame.place(x=740,y=65,width=780,height=350)
        ...
        self.im1=self.im1.resize((655,520),Image.ANTIALIAS)
        self.im1=ImageTk.PhotoImage(self.im1)

        self.lbl_im1=Label(self.root,image=self.im1,bd=2,relief=RAISED)
        self.lbl_im1.place(x=35,y=240)

        self.im2=Image.open("images/category.jpg")
        self.im2=self.im2.resize((630,320),Image.ANTIALIAS)
        self.im2=ImageTk.PhotoImage(self.im2)

        self.lb1_im2=Label(self.root,image=self.im2,bd=2,relief=RAISED)
        self.lb1_im2.place(x=880,y=430)
        ...
        try:        
            if self.var_name.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showwarning("Sucess","category Added Sucessfully",parent=self.root)
                    self.show()
    ...
    def delete(self):
        ...
        try: 
            if self.var_cat_id.get()=="":
                messagebox.showerror("Error","Please Selecet or Enter Category from the list", parent=self.root)
            else: 
